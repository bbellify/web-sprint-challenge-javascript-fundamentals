...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lowPopulationAnimals = array.filter(animal => animal.population < 5);
  ...
  */
  ...
  function USApop(array){
    const USApop = array.reduce((total, animal) => total + animal.population, 0)
    return USApop
  }
...
const cuboidProperties = {
  length:4,
  width:5,
  height:5,
}

const cuboid = new CuboidMaker(cuboidProperties)
...
const cuboidTwoProperties = {
  length:4,
  width:5,
  height:5,
}

const cuboidTwo = new CuboidMakerTwo(cuboidTwoProperties)
